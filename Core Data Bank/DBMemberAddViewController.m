...
- (void)save:(id)sender {
    ...
    [DBMemberController insertMemberWithTitle:self.titleLabel.text parent:self.parentMember inManagedObjectContext:self.parentMember.managedObjectContext];
